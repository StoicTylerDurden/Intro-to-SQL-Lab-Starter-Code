...
SELECT code, name, region, population FROM countries WHERE region = 'Southern Europe' ORDER BY population ASC LIMIT 1;
...
-- Write SQL query here
SELECT * FROM cities WHERE name != 'San Marino' AND countrycode = 'SMR';
...
SELECT name, region, code FROM countries WHERE region = 'South America' AND code = 'BRA';
...
SELECT * FROM cities WHERE id = '211' AND countrycode = 'BRA';
